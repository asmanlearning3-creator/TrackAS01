...
type AppAction =
  ...
  | {
      ...
      payload: { id: string; updates: Partial<Shipment> };
    }
  ...
  | {
      ...
      payload: { id: string; status: Operator["status"] };
    }
  ...
  | {
      ...
      payload: { id: string; status: Vehicle["status"] };
    };
  ...
  shipments: [
    ...
    },
    {
      ...
      updates: [
        {
          time: "12:00",
          message: "Package picked up from Bangalore",
          type: "success",
        },
        ...
        vehicles: state.vehicles.map((vehicle) =>
          vehicle.id === action.payload.id
            ? {
                ...
                status: action.payload.status,
                verificationStatus:
                  action.payload.status === "verified"
                    ? {
