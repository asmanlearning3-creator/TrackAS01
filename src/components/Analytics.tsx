...
const Analytics: React.FC = () => {
  const { state } = useApp();
  const { analytics, realTimeMetrics, analyticsLoading, refetchAnalytics } =
    useDatabase();
  ...
  const metrics = [
    {
      ...
      value:
        analytics?.totalShipments?.toLocaleString() ||
        state.analytics.totalShipments.toLocaleString(),
      change: "+12.5%",
      trend: "up",
      icon: Package,
      color: "text-blue-600",
    ...
    },
    {
      ...
      value: (
        analytics?.activeOperators || state.analytics.activeOperators
      ).toString(),
      change: "+8.3%",
      trend: "up",
      icon: Users,
  ...
  const operatorPerformance =
    analytics?.operatorPerformance || state.analytics.operatorPerformance;
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Performance insights and operational metrics for your logistics
              operations.
            </p>
          </div>
