        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">
              Logistics Company Operational Flow
            </h2>
            <p className="text-gray-600">
              Complete end-to-end process for managing your logistics operations
            </p>
          </div>
                  ...
                  <div className="mt-6 p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg border border-purple-200">
                    ...
                    <p className="text-sm text-purple-700">
                      ...
                      {step.status === "continuous" &&
                        "This step provides ongoing insights and improvements."}
                    </p>
                  </div>
                </div>
              </div>
