        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">
              Operator Operational Flow
            </h2>
            <p className="text-gray-600">
              Complete workflow for vehicle operators and drivers
            </p>
          </div>
                  ...
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      <div className="flex items-center space-x-3 mb-2">
                        ...
                        <div
                          className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(step.status)}`}
                        >
                ...
                <div>
                  ...
                  <div className="mt-6 p-4 bg-gradient-to-br from-orange-50 to-yellow-50 rounded-lg border border-orange-200">
                    ...
                    <p className="text-sm text-orange-700">
                      ...
                      {step.status === "active" &&
                        "This step is currently active and requires attention."}
                      {step.status === "pending" &&
                        "This step is pending and will be available soon."}
                      {step.status === "automated" &&
                        "This step runs automatically in the background."}
                      {step.status === "ongoing" &&
                        "This step is continuously running."}
                      {step.status === "critical" &&
                        "This step is critical for successful delivery."}
                      {step.status === "continuous" &&
                        "This step provides ongoing performance tracking."}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            Step {activeStep} of {operationalSteps.length}
          </p>
