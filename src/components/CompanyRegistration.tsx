  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 3) {
      ...
      if (
        ...
        !emailRegex.test(formData.primaryContactEmail)
      ) {
      ...
      if (
        ...
        !phoneRegex.test(formData.primaryContactPhone)
      ) {
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              Your company registration has been submitted and is now under
              review. You will receive updates within 24-48 hours.
            </p>
              ...
              <div className="space-y-3 text-left">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-blue-800">
                    TIN verification (2-4 hours)
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-blue-800">
                    Business registration cross-check (4-8 hours)
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Register your logistics company to start using TrackAS platform
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p className="text-yellow-700 text-sm mt-2">
                  ...
                  Please ensure all information is accurate to avoid delays in
                  approval.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-blue-700 text-sm mt-2">
                  After submission, your registration will be reviewed within
                  24-48 hours. You'll receive email notifications about the
                  status updates.
                </p>
              </div>
            </div>
