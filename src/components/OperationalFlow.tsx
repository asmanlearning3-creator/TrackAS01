          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                Explore how TrackAS transforms logistics through AI-powered
                shipment tracking, automated assignments, and real-time
                analytics. See the complete end-to-end process that
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={() =>
                    document
                      .getElementById("operational-steps")
