        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Complete journey from booking to delivery completion
            </p>
          </div>
                ...
                <div>
                  ...
                  <div className="mt-6 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-sm text-blue-700">
                      ...
                      {step.status === "active" &&
                        "This step is currently active and requires your attention."}
                      {step.status === "automated" &&
                        "This step happens automatically in the background."}
                      {step.status === "ongoing" &&
                        "This step provides continuous updates."}
                      {step.status === "interactive" &&
                        "This step requires your interaction and confirmation."}
                      {step.status === "optional" &&
                        "This step is optional but helps improve our service."}
                    </p>
                  </div>
                </div>
              </div>
