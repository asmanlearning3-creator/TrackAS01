...
const VerificationDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"companies" | "vehicles">(
    "companies",
  );
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div
            className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(company.status)}`}
          >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-2">
              <div
                className={`p-3 rounded-lg border ${company.verificationStatus.tinVerified ? "bg-green-50 border-green-200" : "bg-gray-50 border-gray-200"}`}
              >
              ...
              <div
                className={`p-3 rounded-lg border ${company.verificationStatus.businessRegVerified ? "bg-green-50 border-green-200" : "bg-gray-50 border-gray-200"}`}
              >
                <div className="flex items-center space-x-2">
              ...
              <div
                className={`p-3 rounded-lg border ${company.verificationStatus.documentsVerified ? "bg-green-50 border-green-200" : "bg-gray-50 border-gray-200"}`}
              >
                <div className="flex items-center space-x-2">
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div
            className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getStatusColor(vehicle.status)}`}
          >
            <StatusIcon className="h-4 w-4 mr-1" />
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mt-2">
              ...
              <p className="text-gray-600">
                License: {vehicle.driver.licenseNumber}
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-2">
              <div
                className={`p-3 rounded-lg border ${vehicle.verificationStatus.registrationVerified ? "bg-green-50 border-green-200" : "bg-gray-50 border-gray-200"}`}
              >
                <div className="flex items-center space-x-2">
              ...
              <div
                className={`p-3 rounded-lg border ${vehicle.verificationStatus.insuranceVerified ? "bg-green-50 border-green-200" : "bg-gray-50 border-gray-200"}`}
              >
                <div className="flex items-center space-x-2">
              ...
              <div
                className={`p-3 rounded-lg border ${vehicle.verificationStatus.licenseVerified ? "bg-green-50 border-green-200" : "bg-gray-50 border-gray-200"}`}
              >
                <div className="flex items-center space-x-2">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Review and approve company and vehicle registrations
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div
                            className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(company.status)}`}
                          >
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(vehicle.status)}`}
                        >
                          <StatusIcon className="h-3 w-3 mr-1" />
                          {vehicle.status}
                        </div>
        ...
        <div className="lg:col-span-2">
          {selectedItem ? (
            activeTab === "companies" ? (
              <CompanyDetails
                company={companies.find((c) => c.id === selectedItem)}
              />
            ) : (
              <VehicleDetails
                vehicle={vehicles.find((v) => v.id === selectedItem)}
              />
            )
          ) : (
